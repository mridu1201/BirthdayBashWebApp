...
function Sidenav() {
   ...
   return (
      <div className="relative">
         <>
            <nav className="fixed top-0 z-50 w-screen bg-white border-b border-gray-200 shadow-md">
               <div className=" py-3 lg:px-5 lg:pl-3 w-screen">
                  <div className="flex items-center justify-between w-full">
                     <div className=" flex items-center w-full">
                        <a href="https://flowbite.com" className="flex ms-2 md:me-24 ">
                           ...
                           <MyDropdown className="justify-end w-screen"/>
                     </div>
                  </div>
               </div>
            </nav>
